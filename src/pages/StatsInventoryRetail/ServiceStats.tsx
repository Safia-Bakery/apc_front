...
import { useInvServiseStatsRetail } from "@/hooks/useInventoryServiseStats";
...
const InventoryServiceStatsRetail = () => {
  ...
  const { isLoading, data } = useInvServiseStatsRetail({
...
export default InventoryServiceStatsRetail;
